...
<title>回执</title>
 ...
 <%
      //这之中的代码只是页面第一次加载的时候才会执行，除此之外，这段代码将不会被执行到
                            //当前日期时间
                            Date date=new Date();
                            //格式化时间
			...
			<div class="body-center">
				...
				<table width="100%" border="1" cellpadding="0" cellspacing="0">
						<tr>
							...
							<td class="tds tdWhdths centess">全称：${sessionScope.Pname}</td>
						</tr>
						<tr>
				...
				<table width="100%" border="1" cellpadding="0" cellspacing="0" style="border-collapse:collapse;">
						<tr>
							...
							<td class="tdpadding tdWhdths tds">${sessionScope.cost}</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td colspan="3" class="tdpadding tdWhdths tds">产品购买</td>
						</tr>
				</table>
